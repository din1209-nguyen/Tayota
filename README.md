...
- Smart API Gateway routing: `/user/**` → operation-service, `/ai/**` → ai-service
...
- Internal gRPC between Gateway and AI Service
...
flowchart TB
    ...
    subgraph FRONTEND["🖥️ Frontend · :3000"]
    ...
    subgraph SERVICES["⚙️ Microservices"]
        OPS["operation-service\nSpring Boot 4.0.5 · :8091"]
        AIS["ai-service\nFastAPI 0.104.1 · :8094"]
    end
...
| API Gateway | operation-service | gRPC |
...
erDiagram
    ...
    GUEST_INFORMATION ||--o{ SERVICE_TICKET : "used in"
...
| `/cars` | ISR | Vehicle catalog rarely changes |
| `/cars/[series]` | SSR | Dynamic series details |
| `/appointments` | SSR `force-dynamic` | Personal data, no cache |
| `/chat` | Client-side | Realtime WebSocket |
| `/ai-consultant` | Client-side | Realtime AI interaction |
| `/admin/*`, `/manager/*` | SSR `force-dynamic` | Personal dashboards |
...
| **Internal RPC** | Spring gRPC 1.0.2, gRPC Java 1.77.1, Protobuf 4.33.4 |
...
|--------|----------|---------|-------------|------|
| POST | `/user/api/v1/auth/register` | operation-service | Register account | — |
| POST | `/user/api/v1/auth/login` | operation-service | Login | — |
| POST | `/user/api/v1/auth/refresh` | operation-service | Refresh token | — |
| GET | `/user/api/v1/auth/me` | operation-service | Current user info | User |
...
| GET | `/user/api/v1/users/{id}` | operation-service | User detail | User |
| GET | `/car/api/v1/series` | operation-service | List car series | — |
| GET | `/car/api/v1/series/{id}` | operation-service | Car series detail | — |
| GET | `/car/api/v1/cars` | operation-service | List cars | — |
| GET | `/car/api/v1/cars/{id}` | operation-service | Car detail + specs | — |
| POST | `/operation/api/v1/appointments` | operation-service | Create appointment | User |
| GET | `/operation/api/v1/appointments` | operation-service | List appointments | User/Staff |
| PATCH | `/operation/api/v1/appointments/{id}` | operation-service | Update appointment status | Staff |
| POST | `/operation/api/v1/workorders` | operation-service | Create work order | Staff |
| GET | `/operation/api/v1/workorders` | operation-service | List work orders | Staff |
| PATCH | `/operation/api/v1/workorders/{id}` | operation-service | Update work order | Mechanic |
| GET | `/ai/api/v1/health` | ai-service | AI health check | — |
...
| Method | Endpoint | Description | Auth |
|--------|----------|-------------|------|
| GET | `/operation/api/v1/admin/stats` | System statistics | Admin |
| GET | `/operation/api/v1/admin/users` | List users | Admin |
| PATCH | `/operation/api/v1/admin/users/{id}/role` | Change role | Admin |
| PATCH | `/operation/api/v1/admin/users/{id}/status` | Ban/unban user | Admin |
| GET | `/ai/api/v1/admin/usage` | AI usage history | Admin |
...
| **Operation Service** | Render | Spring Boot JAR, port `8091` |
| **AI Service** | Render / Railway | FastAPI + Python, port `8094` |
