...
import com.tayota.userservice.enums.review.ReviewType;
...
public class CustomerReviewService {
    ...
    @Transactional
    public CustomerReviewResponse reviewAppointment(UUID userId, UUID appointmentId, CreateCustomerReviewRequest request) {
    ...
    // Guest đánh giá bằng link token qua /reviews/token/{token}.
    @Transactional
    public CustomerReviewResponse reviewServiceTicket(UUID userId, UUID serviceTicketId, CreateCustomerReviewRequest request) {
    ...
    public List<CustomerReviewResponse> getMyReviews(UUID userId) {
