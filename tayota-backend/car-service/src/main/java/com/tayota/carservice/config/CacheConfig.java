package com.tayota.carservice.config;
...
public class CacheConfig {
    ...
    // Khai báo cache manager riêng cho car-service để cấu hình TTL theo từng nhóm dữ liệu
    @Bean
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory, ObjectMapper objectMapper) {
        // Tạo serializer JSON dùng chung với RedisTemplate trong common-core
